    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="dashboard_tendik.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="input_tendik.php" class="nav-link ">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="fasilitas_tendik.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="layanan_tendik.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>layanan</p>
                </a>
              </li>
