                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM m_survey_soal WHERE kategori_id = 5";
                                            $result = $conn->query($sql);

                                            // Tampilkan data dalam tabel HTML
                                            if ($result->num_rows > 0) {
                                                echo "<form method='post' action='submit_kurikulum_dosen.php'>"; // Form untuk submit survey
