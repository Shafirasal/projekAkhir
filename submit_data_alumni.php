...
// Siapkan dan bind
$stmt = $conn->prepare("INSERT INTO t_responden_alumni (survey_id, responden_tanggal, responden_nim, responden_nama, responden_prodi, responden_email, responden_hp, tahun_lulus) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
