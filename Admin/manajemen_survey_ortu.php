                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Kategori Survey Orang Tua</h3>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                // Query SQL untuk mengambil nama kategori dan id
                                                $sql = "SELECT DISTINCT m_kategori.kategori_id, m_kategori.kategori_nama
                                                        ...
                                                        WHERE m_survey_soal.kategori_id IN (8, 9)";
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        switch ($row['kategori_nama']) {
                                                            case 'Layanan Orangtua':
                                                                $infoSoalLink = 'info_soal_layanan_ortu.php?kategori_id=' . htmlspecialchars($row['kategori_id']);
                                                                break;
                                                            case 'Fasilitas Orangtua':
                                                                $infoSoalLink = 'info_soal_fasilitas_ortu.php?kategori_id=' . htmlspecialchars($row['kategori_id']);
                                                                break;
                                                            default:
                                                                $infoSoalLink = '#';
                                                                break;
