                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM m_survey_soal WHERE kategori_id = 10";
                                            $result = $conn->query($sql);

                                            // Tampilkan data dalam tabel HTML
                                            if ($result->num_rows > 0) {
                                                echo "<form method='post' action='submit_kualitas_lulusan_industri.php'>"; // Form untuk submit survey
